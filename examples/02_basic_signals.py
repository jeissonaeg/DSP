...
plt.ylabel('Amplitude')
plt.grid()
plt.savefig("results/images/03_triangle_wave.png", dpi=300)
plt.show()
...
plt.ylabel('Amplitude')
plt.grid()
plt.savefig("results/images/04_white_noise.png", dpi=300)
plt.show()
...
plt.ylabel('Amplitude')
plt.grid()
plt.savefig("results/images/05_composite_signal.png", dpi=300)
plt.show()
